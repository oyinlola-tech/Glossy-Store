  ...
  return (
    <div className="group relative">
      <div className="aspect-square bg-gray-100 dark:bg-gray-800 rounded overflow-hidden mb-4 relative">
        ...
        <button onClick={onAddToCart} className="absolute bottom-0 left-0 right-0 bg-black dark:bg-gray-900 text-white py-2 opacity-0 group-hover:opacity-100 transition-opacity">
          Add To Cart
        </button>
      </div>
