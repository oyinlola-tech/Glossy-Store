import svgPaths from "./svg-1rcepo3ja6";
...
function Roadmap() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-[135px] top-[222px]" data-name="Roadmap">
      ...
      <p className="font-['Poppins:Regular',sans-serif] leading-[21px] not-italic relative shrink-0 text-[14px] text-black">My Account</p>
    </div>
  );
}
...
function Frame28() {
  return (
    <div className="absolute content-stretch flex flex-col font-['Poppins:Regular',sans-serif] gap-[8px] items-start leading-[24px] left-[170px] not-italic text-[16px] top-[363px]">
      <p className="relative shrink-0 text-[#db4444]">My Profile</p>
      <p className="opacity-50 relative shrink-0 text-black">Address Book</p>
      <p className="opacity-50 relative shrink-0 text-black">My Payment Options</p>
    </div>
  );
}
...
function Frame29() {
  return (
    <div className="absolute content-stretch flex flex-col font-['Poppins:Regular',sans-serif] gap-[8px] items-start leading-[24px] left-[170px] not-italic text-[16px] text-black top-[515px]">
      <p className="opacity-50 relative shrink-0">My Returns</p>
      <p className="opacity-50 relative shrink-0">My Cancellations</p>
    </div>
  );
}

function PlaceToInfoBox() {
  return <div className="absolute bg-[#f5f5f5] inset-0 rounded-[4px]" data-name="Place to info box" />;
}

function PlaceboxInfo() {
  return (
    <div className="h-[50px] relative shrink-0 w-[330px]" data-name="Placebox info">
      <PlaceToInfoBox />
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[24px] left-[16px] not-italic opacity-50 text-[16px] text-black top-[13px]">Md</p>
    </div>
  );
}
...
function Frame30() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0">
      <p className="font-['Poppins:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black">First Name</p>
      <PlaceboxInfo />
    </div>
  );
}

function PlaceToInfoBox1() {
  return <div className="absolute bg-[#f5f5f5] inset-0 rounded-[4px]" data-name="Place to info box" />;
}

function PlaceboxInfo1() {
  return (
    <div className="h-[50px] relative shrink-0 w-[330px]" data-name="Placebox info">
      <PlaceToInfoBox1 />
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[24px] left-[16px] not-italic opacity-50 text-[16px] text-black top-[13px]">Rimel</p>
    </div>
  );
}
...
function Frame31() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0">
      <p className="font-['Poppins:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black">Last Name</p>
      <PlaceboxInfo1 />
    </div>
  );
}
...
function Frame37() {
  return (
    <div className="absolute content-stretch flex gap-[50px] items-start left-[80px] top-[84px]">
      <Frame30 />
      <Frame31 />
    </div>
  );
...
function PlaceToInfoBox2() {
  return <div className="absolute bg-[#f5f5f5] inset-0 rounded-[4px]" data-name="Place to info box" />;
}

function PlaceboxInfo2() {
  return (
    <div className="h-[50px] relative shrink-0 w-[330px]" data-name="Placebox info">
      <PlaceToInfoBox2 />
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[24px] left-[16px] not-italic opacity-50 text-[16px] text-black top-[13px]">rimel1111@gmail.com</p>
    </div>
  );
}
...
function Frame32() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0">
      <p className="font-['Poppins:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black">Email</p>
      <PlaceboxInfo2 />
    </div>
  );
}

function PlaceToInfoBox3() {
  return <div className="absolute bg-[#f5f5f5] inset-0 rounded-[4px]" data-name="Place to info box" />;
}

function PlaceboxInfo3() {
  return (
    <div className="h-[50px] relative shrink-0 w-[330px]" data-name="Placebox info">
      <PlaceToInfoBox3 />
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[24px] left-[16px] not-italic opacity-50 text-[16px] text-black top-[13px]">Kingston, 5236, United State</p>
    </div>
  );
}
...
function Frame33() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0">
      <p className="font-['Poppins:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black">Address</p>
      <PlaceboxInfo3 />
    </div>
  );
}
...
function Frame38() {
  return (
    <div className="absolute content-stretch flex gap-[50px] items-start left-[80px] top-[190px]">
      <Frame32 />
      <Frame33 />
    </div>
  );
...
function PlaceToInfoBox4() {
  return <div className="absolute bg-[#f5f5f5] inset-0 rounded-[4px]" data-name="Place to info box" />;
}

function PlaceboxInfo4() {
  return (
    <div className="h-[50px] relative shrink-0 w-[710px]" data-name="Placebox info">
      <PlaceToInfoBox4 />
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[24px] left-[16px] not-italic opacity-50 text-[16px] text-black top-[13px]">Current Passwod</p>
    </div>
  );
}
...
function Frame34() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0">
      <p className="font-['Poppins:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black">Password Changes</p>
      <PlaceboxInfo4 />
    </div>
  );
}

function PlaceToInfoBox5() {
  return <div className="absolute bg-[#f5f5f5] inset-0 rounded-[4px]" data-name="Place to info box" />;
}

function PlaceboxInfo5() {
  return (
    <div className="h-[50px] relative shrink-0 w-[710px]" data-name="Placebox info">
      <PlaceToInfoBox5 />
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[24px] left-[16px] not-italic opacity-50 text-[16px] text-black top-[13px]">New Passwod</p>
    </div>
  );
}

function PlaceToInfoBox6() {
  return <div className="absolute bg-[#f5f5f5] inset-0 rounded-[4px]" data-name="Place to info box" />;
}

function PlaceboxInfo6() {
  return (
    <div className="h-[50px] relative shrink-0 w-[710px]" data-name="Placebox info">
      <PlaceToInfoBox6 />
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[24px] left-[16px] not-italic opacity-50 text-[16px] text-black top-[13px]">Confirm New Passwod</p>
    </div>
  );
}
...
function Frame35() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[80px] top-[296px]">
      <Frame34 />
      <PlaceboxInfo5 />
      <PlaceboxInfo6 />
    </div>
...
function Button() {
  return (
    <div className="bg-[#db4444] content-stretch flex items-center justify-center px-[48px] py-[16px] relative rounded-[4px] shrink-0" data-name="Button">
      <p className="font-['Poppins:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#fafafa] text-[16px]">Save Changes</p>
    </div>
  );
}
...
function Frame36() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[32px] items-center right-[80px] top-[calc(50%+247px)]">
      <p className="font-['Poppins:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black">Cancel</p>
      <Button />
    </div>
  );
}
...
function Frame27() {
  return (
    <div className="absolute bg-white h-[630px] left-[calc(25%+75px)] overflow-clip rounded-[4px] shadow-[0px_1px_13px_0px_rgba(0,0,0,0.05)] top-[323px] w-[870px]">
      <p className="absolute font-['Poppins:Medium',sans-serif] leading-[28px] left-[80px] not-italic text-[#db4444] text-[20px] top-[40px]">Edit Your Profile</p>
      <Frame37 />
      <Frame38 />
      <Frame35 />
      <Frame36 />
...
function Footer() {
  return (
    <div className="absolute bg-black h-[440px] left-0 overflow-clip top-[1093px] w-[1440px]" data-name="Footer">
      <Frame9 />
      <Frame25 />
    </div>
  );
...
export default function Account() {
  return (
    <div className="bg-white relative size-full" data-name="Account">
      <TopHeader />
      <Header />
      <Line />
      <Roadmap />
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[0] left-[calc(83.33%-34px)] not-italic text-[14px] text-black top-[222px]">
        <span className="leading-[21px]">{`Welcome! `}</span>
        <span className="leading-[21px] text-[#db4444]">Md Rimel</span>
      </p>
      <p className="absolute font-['Poppins:Medium',sans-serif] leading-[24px] left-[135px] not-italic text-[16px] text-black top-[323px]">Manage My Account</p>
      <p className="absolute font-['Poppins:Medium',sans-serif] leading-[24px] left-[135px] not-italic text-[16px] text-black top-[475px]">My Orders</p>
      <p className="absolute font-['Poppins:Medium',sans-serif] h-[23px] leading-[24px] left-[135px] not-italic text-[16px] text-black top-[587px] w-[93px] whitespace-pre-wrap">My WishList</p>
      <Frame28 />
      <Frame29 />
      <Frame27 />
      <Footer />
