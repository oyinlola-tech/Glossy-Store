import svgPaths from "./svg-05niw834au";
...
function Frame29() {
  return (
    <div className="absolute content-stretch flex font-['Poppins:Regular',sans-serif] gap-[284px] items-center leading-[24px] left-[40px] not-italic text-[16px] text-black top-[24px]">
      <p className="relative shrink-0">Product</p>
      <p className="relative shrink-0">Price</p>
      <p className="relative shrink-0">Quantity</p>
...
function CartMainSection() {
  return (
    <div className="bg-white h-[72px] overflow-clip relative rounded-[4px] shadow-[0px_1px_13px_0px_rgba(0,0,0,0.05)] shrink-0 w-[1170px]" data-name="Cart Main Section">
      <Frame29 />
    </div>
  );
}

function DropUpSmall() {
  return (
    <div className="relative size-[16px]" data-name="Drop-Up-Small">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Drop-Up-Small">
          <path d={svgPaths.p3288c600} fill="var(--fill-0, black)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function DropDownSmall() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Drop-Down-Small">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Drop-Down-Small">
          <path d={svgPaths.p3288c600} fill="var(--fill-0, black)" id="Vector" />
        </g>
      </svg>
    </div>
...
function Frame27() {
  return (
    <div className="absolute content-stretch flex gap-[16px] items-center left-[12px] top-[6px] w-[48px]">
      <p className="font-['Poppins:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black">01</p>
      <Frame28 />
    </div>
  );
}
...
function Quantity() {
  return (
    <div className="absolute h-[44px] left-[710px] rounded-[4px] top-[29px] w-[72px]" data-name="Quantity">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <Frame27 />
      </div>
      <div aria-hidden="true" className="absolute border-[1.5px] border-[rgba(0,0,0,0.4)] border-solid inset-[-1.5px] pointer-events-none rounded-[5.5px]" />
    </div>
  );
}
...
function MonitorCartSmall() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%-518px)] overflow-clip size-[54px] top-1/2" data-name="Monitor-Cart-Small">
...
function IconCancel() {
  return (
    <div className="absolute left-[30px] size-[24px] top-[20px]" data-name="icon-cancel">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon-cancel">
          <circle cx="12" cy="12" fill="var(--fill-0, #DB4444)" id="Ellipse 26" r="9" />
          <path d={svgPaths.p143bbc10} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function CartSection() {
  return (
    <div className="bg-white h-[102px] overflow-clip relative rounded-[4px] shadow-[0px_1px_13px_0px_rgba(0,0,0,0.05)] shrink-0 w-[1170px]" data-name="Cart Section">
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[24px] left-[387px] not-italic text-[16px] text-black top-[39px]">$650</p>
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[24px] left-[1063px] not-italic text-[16px] text-black top-[39px]">$650</p>
      <Quantity />
      <MonitorCartSmall />
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[24px] left-[114px] not-italic text-[16px] text-black top-[39px]">LCD Monitor</p>
      <IconCancel />
    </div>
  );
}

function DropUpSmall1() {
  return (
    <div className="relative size-[16px]" data-name="Drop-Up-Small">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Drop-Up-Small">
...
function Frame30() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-[12px] top-[6px] w-[48px]">
      <p className="font-['Poppins:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black">02</p>
      <Frame31 />
    </div>
  );
}
...
function GamepadCartSmall() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%-518px)] overflow-clip size-[54px] top-1/2" data-name="Gamepad-Cart-Small">
...
function CartSection1() {
  return (
    <div className="bg-white h-[102px] overflow-clip relative rounded-[4px] shadow-[0px_1px_13px_0px_rgba(0,0,0,0.05)] shrink-0 w-[1170px]" data-name="Cart Section">
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[24px] left-[387px] not-italic text-[16px] text-black top-[39px]">$550</p>
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[24px] left-[1063px] not-italic text-[16px] text-black top-[39px]">$1100</p>
      <Quantity1 />
      <GamepadCartSmall />
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[24px] left-[114px] not-italic text-[16px] text-black top-[39px]">H1 Gamepad</p>
    </div>
  );
}
...
function Button() {
  return (
    <div className="content-stretch flex items-center justify-center px-[48px] py-[16px] relative rounded-[4px] shrink-0" data-name="Button">
      ...
      <p className="font-['Poppins:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black">Return To Shop</p>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="content-stretch flex items-center justify-center px-[48px] py-[16px] relative rounded-[4px] shrink-0" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.5)] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['Poppins:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black">Update Cart</p>
    </div>
  );
}
...
function Frame39() {
  return (
    <div className="content-stretch flex gap-[757px] items-start relative shrink-0">
      <Button />
      <Button1 />
    </div>
  );
...
function Frame32() {
  return (
    <div className="absolute content-stretch flex font-['Poppins:Regular',sans-serif] gap-[307px] items-start leading-[24px] left-[24px] not-italic text-[16px] text-black top-[84px]">
      <p className="relative shrink-0">Subtotal:</p>
...
function Frame33() {
  return (
    <div className="absolute content-stretch flex font-['Poppins:Regular',sans-serif] gap-[314px] items-start leading-[24px] left-[24px] not-italic text-[16px] text-black top-[140px]">
...
function Frame35() {
  return (
    <div className="absolute content-stretch flex font-['Poppins:Regular',sans-serif] gap-[335px] items-start leading-[24px] left-[24px] not-italic text-[16px] text-black top-[196px]">
...
function Button3() {
  return (
    <div className="absolute bg-[#db4444] content-stretch flex items-center justify-center left-[89px] px-[48px] py-[16px] rounded-[4px] top-[236px]" data-name="Button">
      <p className="font-['Poppins:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#fafafa] text-[16px]">Procees to checkout</p>
    </div>
  );
}
...
function UnderLine() {
  return (
    <div className="absolute h-0 left-[24px] top-[124px] w-[422px]" data-name="UnderLine">
...
function UnderLine1() {
  return (
    <div className="absolute h-0 left-[24px] top-[180px] w-[422px]" data-name="UnderLine">
      <div className="absolute inset-[-1px_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 422 1">
          <g id="UnderLine" opacity="0.4">
            <line id="Line 1" stroke="var(--stroke-0, black)" x2="422" y1="0.5" y2="0.5" />
...
function Frame36() {
  return (
    <div className="h-[324px] relative rounded-[4px] shrink-0 w-[470px]">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Poppins:Medium',sans-serif] leading-[28px] left-[24px] not-italic text-[20px] text-black top-[32px]">Cart Total</p>
        <Frame32 />
        <Frame33 />
        <Frame35 />
        <Button3 />
      ...
      <div aria-hidden="true" className="absolute border-[1.5px] border-black border-solid inset-0 pointer-events-none rounded-[4px]" />
    </div>
  );
}
...
function Frame41() {
  return (
    <div className="content-stretch flex gap-[173px] items-start relative shrink-0">
      <Frame37 />
      <Frame36 />
    </div>
  );
...
function Frame42() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[80px] items-start left-[135px] top-[323px]">
      <Frame40 />
      <Frame41 />
    </div>
  );
...
function Footer() {
  return (
    <div className="absolute bg-black h-[440px] left-0 overflow-clip top-[1303px] w-[1440px]" data-name="Footer">
      <Frame9 />
      <Frame25 />
    </div>
  );
...
function Roadmap() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-[135px] top-[222px]" data-name="Roadmap">
      ...
      <p className="font-['Poppins:Regular',sans-serif] leading-[21px] not-italic relative shrink-0 text-[14px] text-black">Cart</p>
    </div>
  );
}
