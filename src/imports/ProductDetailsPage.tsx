import svgPaths from "./svg-jit1yj8f34";
import imgImage63 from "figma:asset/faa80b609e3950aed9181acb44510f859f50d850.png";
import imgImage57 from "figma:asset/14901ccade638588f27b571d7565fbaacfe57243.png";
import imgImage58 from "figma:asset/ca92325b4d31381f7fe4841786f4511bd4849d87.png";
import imgImage61 from "figma:asset/bdcffcaa9b23a76cbe02748d2090a0b9a11cf0a5.png";
import imgImage59 from "figma:asset/f109e9cea445f7c73ec2a2153e0e149e85ee9d28.png";
...
function Roadmap() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-[135px] top-[222px]" data-name="Roadmap">
      ...
      <p className="font-['Poppins:Regular',sans-serif] leading-[21px] not-italic opacity-50 relative shrink-0 text-[14px] text-black">Gaming</p>
      <div className="flex h-[11.75px] items-center justify-center relative shrink-0 w-[6px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "22" } as React.CSSProperties}>
        <div className="flex-none rotate-[117.05deg]">
          <div className="h-0 relative w-[13.193px]">
            <div className="absolute inset-[-1px_0_0_0]">
      ...
      <p className="font-['Poppins:Regular',sans-serif] leading-[21px] not-italic relative shrink-0 text-[14px] text-black">Havic HV G-92 Gamepad</p>
    </div>
  );
}
...
function Frame50() {
  return (
    <div className="absolute bg-[#f5f5f5] h-[600px] left-[calc(16.67%+95px)] overflow-clip rounded-[4px] top-[323px] w-[500px]">
      <div className="absolute h-[315px] left-[27px] top-[154px] w-[446px]" data-name="image 63">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[122.46%] left-[-8.85%] max-w-none top-[-8.45%] w-[115.27%]" src={imgImage63} />
        </div>
      </div>
    </div>
  );
...
function Frame51() {
  return (
    <div className="absolute bg-[#f5f5f5] h-[138px] left-[135px] overflow-clip rounded-[4px] top-[323px] w-[170px]">
      <div className="absolute flex h-[114px] items-center justify-center left-[24px] top-[12px] w-[121px]">
        <div className="-scale-y-100 flex-none rotate-180">
          <div className="h-[114px] relative w-[121px]" data-name="image 57">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <img alt="" className="absolute h-[130.29%] left-[-13.39%] max-w-none top-[-14.98%] w-[121.77%]" src={imgImage57} />
            </div>
          </div>
        </div>
      </div>
...
function Frame52() {
  return (
    <div className="absolute bg-[#f5f5f5] h-[138px] left-[135px] overflow-clip rounded-[4px] top-[477px] w-[170px]">
      <div className="absolute flex h-[97px] items-center justify-center left-[29px] top-[20px] w-[112px]">
        <div className="-scale-y-100 flex-none rotate-180">
          <div className="h-[97px] relative w-[112px]" data-name="image 58">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <img alt="" className="absolute h-[102.11%] left-[-29.21%] max-w-none top-0 w-[157.89%]" src={imgImage58} />
            </div>
          </div>
        </div>
      </div>
...
function Frame53() {
  return (
    <div className="absolute bg-[#f5f5f5] h-[138px] left-[135px] overflow-clip rounded-[4px] top-[631px] w-[170px]">
      <div className="absolute h-[94px] left-[18px] top-[22px] w-[134px]" data-name="image 61">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[188.33%] left-[-14.19%] max-w-none top-[-57.25%] w-[131%]" src={imgImage61} />
        </div>
      </div>
    </div>
  );
...
function Frame71() {
  return (
    <div className="absolute bg-[#f5f5f5] h-[138px] left-[135px] overflow-clip rounded-[4px] top-[785px] w-[170px]">
      <div className="absolute h-[106px] left-[24px] top-[16px] w-[122px]" data-name="image 59">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[124.53%] left-[-4.19%] max-w-none top-[-10.06%] w-[107.73%]" src={imgImage59} />
        </div>
      </div>
    </div>
  );
...
function Frame72() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0">
      <FourStar />
      <p className="font-['Poppins:Regular',sans-serif] leading-[21px] not-italic opacity-50 relative shrink-0 text-[14px] text-black">(150 Reviews)</p>
    </div>
  );
}
...
function Frame73() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
      <div className="flex h-[16px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "22" } as React.CSSProperties}>
        <div className="flex-none rotate-90">
          <div className="h-0 relative w-[16px]">
            <div className="absolute inset-[-1px_0_0_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 1">
                <line id="Line 17" opacity="0.5" stroke="var(--stroke-0, black)" x2="16" y1="0.5" y2="0.5" />
              </svg>
            </div>
          </div>
        </div>
      </div>
      <p className="font-['Poppins:Regular',sans-serif] leading-[21px] not-italic opacity-60 relative shrink-0 text-[#0f6] text-[14px]">In Stock</p>
    </div>
  );
}
...
function Frame74() {
  return (
    <div className="absolute content-stretch flex gap-[16px] items-start left-[calc(66.67%-55px)] top-[363px]">
      <Frame72 />
      <Frame73 />
    </div>
  );
      ...
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 20">
        <g id="Colour Chnage">
          <g id="Group 1000005935">
            <circle cx="10" cy="10" fill="var(--fill-0, #A0BCE0)" id="Ellipse 9" r="6" />
            <circle cx="10" cy="10" id="Ellipse 10" r="9" stroke="var(--stroke-0, black)" strokeWidth="2" />
          </g>
          <circle cx="38" cy="10" fill="var(--fill-0, #E07575)" id="Ellipse 8" r="10" />
        </g>
      </svg>
    </div>
  );
...
function Frame70() {
  return (
    <div className="absolute content-stretch flex gap-[24px] items-start left-[calc(66.67%-54px)] top-[559px]">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[20px] text-black tracking-[0.6px]">Colours:</p>
      <ColourChnage />
    </div>
  );
}
  ...
  return (
    <div className="relative rounded-[4px] shrink-0 size-[32px]">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Poppins:Medium',sans-serif] h-[20px] leading-[21px] left-[calc(50%-9px)] not-italic text-[14px] text-black top-[calc(50%-10px)] w-[18px] whitespace-pre-wrap">XS</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.5)] border-solid inset-[-1px] pointer-events-none rounded-[5px]" />
    </div>
  );
}
...
function Frame56() {
  return (
    <div className="relative rounded-[4px] shrink-0 size-[32px]">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Poppins:Medium',sans-serif] h-[20px] leading-[21px] left-[calc(50%-4px)] not-italic text-[14px] text-black top-[calc(50%-10px)] w-[8px] whitespace-pre-wrap">S</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.5)] border-solid inset-[-1px] pointer-events-none rounded-[5px]" />
    </div>
  );
...
function Frame55() {
  return (
    <div className="bg-[#db4444] overflow-clip relative rounded-[4px] shrink-0 size-[32px]">
      <p className="absolute font-['Poppins:Medium',sans-serif] h-[20px] leading-[21px] left-[calc(50%-6px)] not-italic text-[#fafafa] text-[14px] top-[calc(50%-10px)] w-[12px] whitespace-pre-wrap">M</p>
    </div>
  );
}
...
function Frame57() {
  return (
    <div className="relative rounded-[4px] shrink-0 size-[32px]">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Poppins:Medium',sans-serif] h-[20px] leading-[21px] left-[calc(50%-3px)] not-italic text-[14px] text-black top-[calc(50%-10px)] w-[6px] whitespace-pre-wrap">L</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.5)] border-solid inset-[-1px] pointer-events-none rounded-[5px]" />
    </div>
  );
...
function Frame58() {
  return (
    <div className="relative rounded-[4px] shrink-0 size-[32px]">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Poppins:Medium',sans-serif] h-[20px] leading-[21px] left-[calc(50%-8px)] not-italic text-[14px] text-black top-[calc(50%-10px)] w-[16px] whitespace-pre-wrap">XL</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.5)] border-solid inset-[-1px] pointer-events-none rounded-[5px]" />
    </div>
  );
...
function Frame69() {
  return (
    <div className="absolute content-stretch flex gap-[24px] items-center left-[calc(66.67%-54px)] top-[603px]">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[20px] text-black tracking-[0.6px]">Size:</p>
      <Frame68 />
    </div>
  );
}
...
function UnderLine() {
  return (
    <div className="absolute h-0 left-[calc(66.67%-55px)] top-[535px] w-[400px]" data-name="UnderLine">
      <div className="absolute inset-[-1px_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 400 1">
          <g id="UnderLine" opacity="0.5">
            <line id="Line 1" stroke="var(--stroke-0, black)" x2="400" y1="0.5" y2="0.5" />
          </g>
        </svg>
      </div>
    </div>
...
function IconMinus() {
  return (
    <div className="absolute left-[8px] size-[24px] top-[10px]" data-name="icon-minus">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon-minus">
          <path d="M20 12H4" id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Frame60() {
  return (
    <div className="h-[44px] mr-[-1px] relative rounded-bl-[4px] rounded-tl-[4px] shrink-0 w-[40px]">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <IconMinus />
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.5)] border-solid inset-0 pointer-events-none rounded-bl-[4px] rounded-tl-[4px]" />
    </div>
  );
}
...
function Frame62() {
  return (
    <div className="h-[44px] mr-[-1px] relative shrink-0 w-[80px]">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Poppins:Medium',sans-serif] leading-[28px] left-[34px] not-italic text-[20px] text-black top-[8px]">2</p>
      </div>
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.5)] border-b border-solid border-t inset-0 pointer-events-none" />
    </div>
  );
}
...
function IconPlus() {
  return (
    <div className="absolute left-[9px] size-[24px] top-[10px]" data-name="icon-plus">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon-plus">
          <path d={svgPaths.peef4e80} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Frame61() {
  return (
    <div className="bg-[#db4444] h-[44px] mr-[-1px] overflow-clip relative rounded-br-[4px] rounded-tr-[4px] shrink-0 w-[41px]">
      <IconPlus />
    </div>
  );
}
...
function Frame78() {
  return (
    <div className="absolute content-stretch flex h-[44px] items-start left-[calc(66.67%-54px)] pr-px top-[659px] w-[159px]">
      <Frame60 />
      <Frame62 />
      <Frame61 />
    </div>
...
function Button() {
  return (
    <div className="absolute bg-[#db4444] content-stretch flex items-center justify-center left-[calc(75%+1px)] px-[48px] py-[10px] rounded-[4px] top-[659px]" data-name="Button">
...
function Wishlist1() {
  return (
    <div className="absolute left-[4px] size-[32px] top-[4px]" data-name="Wishlist">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="Wishlist">
          <path d={svgPaths.p38d3300} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
...
function Frame59() {
  return (
    <div className="absolute left-[calc(91.67%-55px)] rounded-[4px] size-[40px] top-[661px]">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <Wishlist1 />
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.5)] border-solid inset-[-1px] pointer-events-none rounded-[5px]" />
...
function UnderLine1() {
  return (
    <div className="absolute h-0 left-[-1px] top-[89px] w-[399px]" data-name="UnderLine">
      <div className="absolute inset-[-1px_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 399 1">
          <g id="UnderLine" opacity="0.5">
            <line id="Line 1" stroke="var(--stroke-0, black)" x2="399" y1="0.5" y2="0.5" />
          </g>
        </svg>
      </div>
    </div>
...
function IconDelivery() {
  return (
    <div className="relative shrink-0 size-[40px]" data-name="icon-delivery">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
        <g clipPath="url(#clip0_1_12957)" id="icon-delivery">
          <g id="Vector" />
          <path d={svgPaths.p3bd1d840} id="Vector_2" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p3812a700} id="Vector_3" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p3a65e600} id="Vector_4" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p1f17ca80} id="Vector_5" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M5 11.8182H11.6667" id="Vector_6" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M1.81818 15.4545H8.48485" id="Vector_7" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M5 19.0909H11.6667" id="Vector_8" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
        <defs>
...
function Frame65() {
  return (
    <div className="content-stretch flex flex-col font-['Poppins:Medium',sans-serif] gap-[8px] items-start not-italic relative shrink-0 text-black">
      <p className="leading-[24px] relative shrink-0 text-[16px]">Free Delivery</p>
      <p className="[text-decoration-skip-ink:none] decoration-solid leading-[18px] relative shrink-0 text-[12px] underline">Enter your postal code for Delivery Availability</p>
    </div>
  );
}
...
function Frame67() {
  return (
    <div className="absolute content-stretch flex gap-[16px] items-center left-[15px] top-[23px]">
      <IconDelivery />
      <Frame65 />
    </div>
  );
...
function IconReturn() {
  return (
    <div className="relative shrink-0 size-[40px]" data-name="Icon-return">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
        <g clipPath="url(#clip0_1_12927)" id="Icon-return">
          <g id="Vector" />
          <path d={svgPaths.p5015100} id="Vector_2" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p24c8dd80} id="Vector_3" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
        <defs>
          <clipPath id="clip0_1_12927">
            <rect fill="white" height="40" width="40" />
          </clipPath>
        </defs>
      </svg>
...
function Frame64() {
  return (
    <div className="content-stretch flex flex-col font-['Poppins:Medium',sans-serif] gap-[8px] items-start not-italic relative shrink-0 text-black">
      <p className="leading-[24px] relative shrink-0 text-[16px]">Return Delivery</p>
      <p className="leading-[0] relative shrink-0 text-[0px] text-[12px]">
        <span className="leading-[18px]">{`Free 30 Days Delivery Returns. `}</span>
        <span className="[text-decoration-skip-ink:none] decoration-solid leading-[18px] underline">Details</span>
      </p>
    </div>
  );
}
...
function Frame66() {
  return (
    <div className="absolute content-stretch flex gap-[16px] items-center left-[15px] top-[105px]">
      <IconReturn />
      <Frame64 />
    </div>
  );
...
function Frame63() {
  return (
    <div className="absolute border border-[rgba(0,0,0,0.5)] border-solid h-[180px] left-[calc(66.67%-54px)] overflow-clip rounded-[4px] top-[743px] w-[399px]">
      <UnderLine1 />
      <Frame67 />
      <Frame66 />
    </div>
...
function CategoryRectangle() {
  return (
    <div className="h-[40px] relative shrink-0 w-[20px]" data-name="Category Rectangle">
...
function Frame75() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
      <CategoryRectangle />
      <p className="font-['Poppins:SemiBold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#db4444] text-[16px]">Related Item</p>
    </div>
  );
}
...
function Frame77() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[60px] items-start left-[135px] top-[1063px]">
      <Frame75 />
      <Frame76 />
    </div>
  );
...
function Footer() {
  return (
    <div className="absolute bg-black h-[440px] left-0 overflow-clip top-[1653px] w-[1440px]" data-name="Footer">
      <Frame32 />
      <Frame48 />
    </div>
  );
...
export default function ProductDetailsPage() {
  return (
    <div className="bg-white relative size-full" data-name="Product Details page">
      <TopHeader />
      <Header />
      <Line />
      <Roadmap />
      ...
      <Frame53 />
      <Frame71 />
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-[calc(66.67%-55px)] not-italic text-[24px] text-black top-[323px] tracking-[0.72px]">Havic HV G-92 Gamepad</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[calc(66.67%-55px)] not-italic text-[24px] text-black top-[400px] tracking-[0.72px]">$192.00</p>
      <Frame74 />
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[21px] left-[calc(66.67%-55px)] not-italic text-[14px] text-black top-[448px] w-[373px] whitespace-pre-wrap">{`PlayStation 5 Controller Skin High quality vinyl with air channel adhesive for easy bubble free install & mess free removal Pressure sensitive.`}</p>
      <Frame70 />
      <Frame69 />
      <UnderLine />
      <Frame78 />
