import svgPaths from "./svg-xkp36d2h5h";
...
function Cart1() {
  return (
    <div className="absolute inset-0 overflow-clip" data-name="Cart1">
      <div className="absolute inset-[78.13%_62.5%_15.63%_31.25%]" data-name="Vector">
        <div className="absolute inset-[-37.5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3.5 3.5">
            <path d={svgPaths.p1013cd00} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[15.63%] left-3/4 right-[18.75%] top-[78.13%]" data-name="Vector">
        <div className="absolute inset-[-37.5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3.5 3.5">
            <path d={svgPaths.p1013cd00} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          </svg>
      ...
      <div className="absolute inset-[15.63%_18.75%_31.25%_9.38%]" data-name="Vector">
        <div className="absolute inset-[-4.41%_-3.26%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24.5 18.5">
            <path d={svgPaths.p2733eb80} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[47.92%] left-1/4 right-[12.84%] top-[20.83%]" data-name="Vector">
        <div className="absolute inset-[-7.5%_-3.77%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21.3903 11.5">
            <path d={svgPaths.p1a07bb20} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          </svg>
        </div>
      </div>
    </div>
...
function Footer() {
  return (
    <div className="absolute bg-black h-[440px] left-0 overflow-clip top-[1346px] w-[1440px]" data-name="Footer">
      <Frame45 />
      <Frame61 />
    </div>
  );
...
function Button() {
  return (
    <div className="content-stretch flex items-center justify-center px-[48px] py-[16px] relative rounded-[4px] shrink-0" data-name="Button">
      ...
      <p className="font-['Poppins:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black">Move All To Bag</p>
    </div>
  );
}
...
function Frame64() {
  return (
    <div className="content-stretch flex gap-[835px] items-center relative shrink-0">
      <p className="font-['Poppins:Regular',sans-serif] leading-[26px] not-italic relative shrink-0 text-[20px] text-black text-center">Wishlist (4)</p>
      <Button />
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[34px]" data-name="Fill Eye">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Fill Eye">
          ...
          <g id="icon-delete">
            <path d={svgPaths.p224e8600} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.56" />
          </g>
        </g>
      </svg>
    </div>
...
function Frame11() {
  return (
    <div className="absolute content-stretch flex flex-col items-start right-[12px] top-[12px]">
      <FillEye />
    </div>
  );
}
...
function Frame39() {
  return (
    <div className="absolute h-[180px] left-[40px] overflow-clip top-[15px] w-[190px]">
...
function Cart3() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Cart1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Cart1">
          <path d={svgPaths.p31c17200} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p4fd100} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p39b9d000} id="Vector_3" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p36afedc0} id="Vector_4" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Frame63() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex gap-[8px] items-center left-[calc(50%+0.5px)] top-[calc(50%+104px)]">
      <Cart3 />
      <p className="font-['Poppins:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[12px] text-white">Add To Cart</p>
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="content-stretch flex flex-col font-['Poppins:Medium',sans-serif] gap-[8px] items-start leading-[24px] not-italic relative shrink-0 text-[16px]">
      <p className="relative shrink-0 text-black">Gucci duffle bag</p>
      <Frame10 />
    </div>
  );
}
...
function Frame40() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[180px] left-1/2 overflow-clip top-[calc(50%-17px)] w-[190px]">
...
function Frame15() {
  return (
    <div className="content-stretch flex items-start relative shrink-0">
      <p className="font-['Poppins:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#db4444] text-[16px]">$1960</p>
    </div>
  );
}
...
function Frame38() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[180px] left-1/2 overflow-clip top-[calc(50%-13px)] w-[190px]">
...
function Frame18() {
  return (
    <div className="content-stretch flex items-start relative shrink-0">
      <p className="font-['Poppins:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#db4444] text-[16px]">$550</p>
    </div>
  );
}
...
function Frame21() {
  return (
    <div className="content-stretch flex items-start relative shrink-0">
      <p className="font-['Poppins:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#db4444] text-[16px]">$750</p>
    </div>
  );
}
...
function Frame73() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
      <CategoryRectangle />
      <p className="font-['Poppins:Regular',sans-serif] leading-[26px] not-italic relative shrink-0 text-[20px] text-black text-center">Just For You</p>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="content-stretch flex items-center justify-center px-[48px] py-[16px] relative rounded-[4px] shrink-0" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.5)] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['Poppins:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black">See All</p>
    </div>
  );
}
...
function Frame74() {
  return (
    <div className="content-stretch flex gap-[864px] items-center relative shrink-0">
      <Frame73 />
      <Button1 />
    </div>
  );
...
function Frame71() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center left-[85px] top-[218px]">
      <Cart15 />
      <p className="font-['Poppins:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[12px] text-white">Add To Cart</p>
    </div>
  );
...
function Frame37() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[180px] left-1/2 overflow-clip top-[calc(50%-13px)] w-[190px]">
      <div className="absolute h-[166px] left-[16px] top-[7px] w-[158px]" data-name="ideapad-gaming-3i-01-500x500 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function Frame31() {
  return (
    <div className="content-stretch flex items-start relative shrink-0">
      <p className="font-['Poppins:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#db4444] text-[16px]">$560</p>
    </div>
  );
}
...
function Frame35() {
  return (
    <div className="content-stretch flex items-start relative shrink-0">
      <p className="font-['Poppins:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#db4444] text-[16px]">$200</p>
    </div>
  );
}
...
function Frame76() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[80px] items-start left-[135px] top-[222px]">
      <Frame66 />
      <Frame75 />
    </div>
  );
